...
<article class="post-card post">
	...
	<a class="post-card-image-link" href="<?php echo $p->url;?>">
        <img alt="youtube image <?php echo $p->title;?>" src="//img.youtube.com/vi/<?php echo get_video_id($p->video);?>/sddefault.jpg" width="100%">
	</a>
	<?php } ?>
	
	<?php if (!empty($p->audio)) { ?>
	<a class="post-card-image-link" href="<?php echo $p->url;?>">
        <img alt="soundcloud image <?php echo $p->title;?>" src="<?php echo theme_path();?>images/soundcloud.jpg" width="100%">
	</a>
	<?php } ?>
