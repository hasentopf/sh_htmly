    ...
    <section class="post-full-content">
        <div class="post-content">
            ...
            <?php if (!empty($p->video)) { ?>
                <p><iframe width="100%" height="315" src="https://www.youtube.com/embed/<?php echo get_video_id($p->video); ?>" allowfullscreen></iframe></p>
            <?php } ?>
            <?php if (!empty($p->audio)) { ?>
                <p><iframe class="embed-responsive-item" width="100%" height="200" src="https://w.soundcloud.com/player/?url=<?php echo $p->audio; ?>&amp;auto_play=false&amp;visual=true"></iframe></p>
            <?php } ?>
